...
2. Clone your fork: `git clone https://github.com/qapquiz/comet.git`
3. Navigate to the project directory: `cd comet`
...
If you have any questions, please [open an issue](https://github.com/qapquiz/comet/issues/new) for discussion.
